...
const css = `
.candy-bg {
    background: radial-gradient(circle at 50% 0%, rgba(184, 134, 11, 0.15) 0%, transparent 50%),
  ...
  .gradient-blur {
    background: radial-gradient(600px circle at 50% 0%, rgba(184,134,11,0.18) 0%, transparent 70%);
  }`;
    ...
    <section className="relative -mt-8  py-32 overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="relative mx-auto mt-24 flex h-112 max-w-5xl items-center justify-center gap-6">
          {[
            { value: 35, label: "Average Shops", delay: 0.2 },
            { value: 42, label: "Chain Stores", delay: 0.4 },
            {
              value: 97,
              label: "The Bridge",
              className: "bg-gradient-to-tr from-[#B8860B] to-[#DAA520]",
              showToolTip: true,
              delay: 0.6,
            },
        ...
        >
          <div
            className={cn(
              ...
              className.includes("bg-gradient") && "bg-[#B8860B] border-[#DAA520]"
            )}
          />
          <svg
            className={cn(
          ...
          <span className="text-sm font-medium">5-Star Excellence</span>
        </motion.div>
      </motion.div>
